...
function App() {
  ...
  return (
    <main className="flex flex-col h-screen p-0">
      ...
      <div className='flex flex-1 overflow-hidden'>
        {/* Main content */}
        <aside className='w-72 border-r border-gray-300 dark:border-gray-700'>
        ...
        <div className="flex-1 bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
          <div className="text-center text-gray-500 dark:text-gray-400">
            <p className="text-lg mb-2">Grid will appear here</p>
